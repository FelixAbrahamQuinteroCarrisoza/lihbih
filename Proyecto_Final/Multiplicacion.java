...
public class Multiplicacion extends Menu {
	
	JPanel panelMulti;
	JLabel fondoMulti;
	JLabel nombreJugadorMulti;
	Clip sonidomulti = null;
	
	 public void Multiplicacion() {
		 
		//panel del menu
		 panelMulti = new JPanel();
		 panelMulti.setSize(ventana.getWidth(), ventana.getHeight());
		 panelMulti.setLocation(0, 0);
		 panelMulti.setLayout(null); 
		 panelMulti.setVisible(true);
					
					
		 //fondo del menu
		 fondoMulti = new JLabel();
		 fondoMulti.setSize(ventana.getWidth(), ventana.getHeight());
		 fondoMulti.setLocation(0, 0);
		 fondoMulti.setIcon(new ImageIcon("Imagenes/imgMulti.png"));
		 fondoMulti.setVisible(true);
		 panelMulti.add(fondoMulti,0);
			
		 //nombre de jugador
		 nombreJugadorMulti = new JLabel();
		 nombreJugadorMulti.setSize(100, 20);
		 nombreJugadorMulti.setLocation(20, 80);
		 nombreJugadorMulti.setForeground(Color.WHITE);
		 nombreJugadorMulti.setVisible(true);
		 panelMulti.add(nombreJugadorMulti,0);
			
			//cronometro de jugador
			cronometro = new JLabel();
			cronometro.setSize(80, 20);
			cronometro.setLocation(ventana.getWidth()-100, 70);
			cronometro.setForeground(Color.BLACK);
			cronometro.setVisible(true);
			panelMulti.add(cronometro,0);
			...
			panelMulti.add(imgVidas3,0);	
			
			RegresarBoton = new JLabel();
			RegresarBoton.setSize(80, 80);
			RegresarBoton.setLocation(30, 420);
			RegresarBoton.setIcon(new ImageIcon("Imagenes/BotonVerde.png"));
			RegresarBoton.setVisible(true);
			panelMulti.add(RegresarBoton,0);
			...
			PresRegresarBoton.setIcon(new ImageIcon("Imagenes/PresBotonVerde.png"));
			PresRegresarBoton.setVisible(false);
			panelMulti.add(PresRegresarBoton,0);
			
			//Boton para ver el puntaje
			InformacionBoton = new JLabel();
			InformacionBoton.setSize(80, 80);
			InformacionBoton.setLocation(120, 420);
			InformacionBoton.setIcon(new ImageIcon("Imagenes/PuntosVerde.png"));
			InformacionBoton.setVisible(true);
			panelMulti.add(InformacionBoton,0);
			...
			//MUSICA PARA EL FONDO DEL JUEGO Multiplicacion
			try {
				sonidomulti = AudioSystem.getClip();
			} catch (LineUnavailableException e2) {
				// TODO Auto-generated catch block
				e2.printStackTrace();
			}
		    File amulti = new File("Imagenes\\y2mate.com - Música de Super Mario Galaxy 2 - Estrella Verde.wav");
		    try {
		    	sonidomulti.open(AudioSystem.getAudioInputStream(amulti));
			} catch (LineUnavailableException | IOException
					| UnsupportedAudioFileException e2) {
				// TODO Auto-generated catch block
				e2.printStackTrace();
		    ...
		    //Activar sonido
		    sonidomulti.start();
		    sonidomulti.loop(Clip.LOOP_CONTINUOUSLY);
												...
												if( matAux[k][l] == 0 && contador != 2) {
													...
													if( contador == 2 && contSegEsp == 1 ) {
														...
														if(matAux[actualx][actualy] != matAux[antx][anty]) {
															...
															do {
															do {
															int numeroMulti= (int)(Math.random()*10); 
															int numeroMulti2= (int)(Math.random()*10); 
															++vidas;
															++contvid;
														 if(vidas==1) {
																...
																res=numeroMulti*numeroMulti2;
																n = JOptionPane.showInputDialog(ventana,"Coloca la respuesta de la Multiplicacion\n"+numeroMulti+"x"+numeroMulti2+"=","Escribe aqui");
			...
			tiempo.start();
			nombreJugadorMulti.setText("Jugador: "+Jugador);
			ventana.add(panelMulti);
			panelMulti.setVisible(true);
