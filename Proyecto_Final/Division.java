...
public class Division extends Menu {
	
	JPanel panelDivision;
	JLabel fondoDivision;
	JLabel nombreJugadorDivision;
	Clip sonidodivi = null;
	
	public void Division(){
		
		//panel del menu
		panelDivision = new JPanel();
		panelDivision.setSize(ventana.getWidth(), ventana.getHeight());
		panelDivision.setLocation(0, 0);
		panelDivision.setLayout(null); 
		panelDivision.setVisible(true);
								
								
		//fondo del menu
		fondoDivision = new JLabel();
		fondoDivision.setSize(ventana.getWidth(), ventana.getHeight());
		fondoDivision.setLocation(0, 0);
		fondoDivision.setIcon(new ImageIcon("Imagenes/imgdivision.png"));
		fondoDivision.setVisible(true);
		panelDivision.add(fondoDivision,0);
						
		//nombre de jugador
		nombreJugadorDivision = new JLabel();
		nombreJugadorDivision.setSize(100, 20);
		nombreJugadorDivision.setLocation(20, 80);
		nombreJugadorDivision.setForeground(Color.WHITE);
		nombreJugadorDivision.setVisible(true);
		panelDivision.add(nombreJugadorDivision,0);
		...
		panelDivision.add(imgVidas3,0);	
		
		RegresarBoton = new JLabel();
		RegresarBoton.setSize(80, 80);
		RegresarBoton.setLocation(30, 420);
		RegresarBoton.setIcon(new ImageIcon("Imagenes/BotonAmarillo.png"));
		RegresarBoton.setVisible(true);
		panelDivision.add(RegresarBoton,0);
		...
		PresRegresarBoton.setIcon(new ImageIcon("Imagenes/PresBotonAmarillo.png"));
		PresRegresarBoton.setVisible(false);
		panelDivision.add(PresRegresarBoton,0);
		
		//Boton para ver el puntaje
		InformacionBoton = new JLabel();
		InformacionBoton.setSize(80, 80);
		InformacionBoton.setLocation(120, 420);
		InformacionBoton.setIcon(new ImageIcon("Imagenes/PuntosAmarillo.png"));
		InformacionBoton.setVisible(true);
		panelDivision.add(InformacionBoton,0);
		...
		//MUSICA PARA EL FONDO DEL JUEGO Division
				try {
					sonidodivi = AudioSystem.getClip();
				} catch (LineUnavailableException e2) {
					// TODO Auto-generated catch block
					e2.printStackTrace();
				}
			    File adiv = new File("Imagenes\\musica-de-super-mario-galaxy-2-mundo-1-2.wav");
			    try {
			    	sonidodivi.open(AudioSystem.getAudioInputStream(adiv));
				} catch (LineUnavailableException | IOException
						| UnsupportedAudioFileException e2) {
					// TODO Auto-generated catch block
					e2.printStackTrace();
			    ...
			    //Activar sonido
			    sonidodivi.start();
			    sonidodivi.loop(Clip.LOOP_CONTINUOUSLY);
		...
		//matriz de imagenes
				...
				for(int i=0; i<4; i++) {
					for(int j=0; j<5; j++) {
						...
						panelDivision.add(matriz[i][j],0); 
							}
						}
										...
										if(e.getSource() == matriz[k][l]) {
											...
											if( matAux[k][l] == 0 && contador != 2) {
												...
												do {
													do {
														do{	
														 int numeroDiv3= (int)(Math.random()*10+1); 
														 int numeroDiv23= (int)(Math.random()*10+1);
														 numeroDiv=numeroDiv3;
														 numeroDiv2=numeroDiv23;
														}while(numeroDiv%numeroDiv2!=0 || numeroDiv2==0 );	
													 ...
													 if(vidas==1) {
															...
															res=numeroDiv/numeroDiv2;
															if(numeroDiv2==0) {
															res=numeroDiv2/numeroDiv;
															n = JOptionPane.showInputDialog(ventana,"Coloca la respuesta de la Division\n"+numeroDiv2+"/"+numeroDiv+"=","Escribe aqui");
															while( n == null || n.compareTo("Escribe aqui") ==0 || n.compareTo("")==0) {
																n = JOptionPane.showInputDialog(ventana,"Coloca la respuesta de la Division\n"+numeroDiv2+"/"+numeroDiv+"=","Escribe aqui");
															 }
															}
															else {
																n = JOptionPane.showInputDialog(ventana,"Coloca la respuesta de la Division\n"+numeroDiv+"/"+numeroDiv2+"=","Escribe aqui");
																while( n == null || n.compareTo("Escribe aqui") ==0 || n.compareTo("")==0) {
																	n = JOptionPane.showInputDialog(ventana,"Coloca la respuesta de la Division\n"+numeroDiv+"/"+numeroDiv2+"=","Escribe aqui");
																 }	
															}
		...
		tiempo.start();
		nombreJugadorDivision.setText("Jugador: "+Jugador);
